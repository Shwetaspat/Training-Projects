 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://DefaultNamespace", wsdlLocation = "http://localhost:8080/SimpleSoapCalculatorDynamic/services/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://DefaultNamespace", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SimpleSoapCalculatorDynamic/services/Calculator?wsdl");
    ...
    public Calculator getCalculator() {
        return super.getPort(new QName("http://DefaultNamespace", "Calculator"), Calculator.class);
    }
    ...
    public Calculator getCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://DefaultNamespace", "Calculator"), Calculator.class, features);
    }
